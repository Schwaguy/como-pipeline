 ...
 */
class Como_Pipeline_Widget extends WP_Widget {
	/**
	...
	function __construct() {
		...
		$name 					= esc_html__( 'Como Pipeline', 'como-pipeline' );
		$opts['classname'] 		= '';
		$opts['description'] 	= esc_html__( 'Display candidate postings on a sidebar', 'como-pipeline' );
	...
	function widget( $args, $instance ) {
		...
		ob_start();
		include( plugin_dir_path( __FILE__ ) . 'partials/como-pipeline-display-widget.php' );
